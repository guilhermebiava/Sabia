...
<img src="assets/diagrama.png" alt="Diagrama da arquitetura da aplicação" width="600"/>

> _**#ParaTodosVerem:** Diagrama da arquitetura da aplicação. À esquerda, há um ícone de usuário enviando uma pergunta para a aplicação (representada por um computador)..._
